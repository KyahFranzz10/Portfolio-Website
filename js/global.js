document.addEventListener('DOMContentLoaded', () => {
    ...
    const initChatbot = () => {
        const knowledgeBase = [
            ...
            { keywords: ['skill', 'tech', 'stack', 'language', 'know', 'html', 'css', 'javascript', 'php', 'laravel', 'firebase', 'supabase', 'hostinger', 'dart', 'flutter'], responses: ["I am highly skilled in Frontend (HTML, CSS, JS, React), Backend (Node.js, Python, PHP/Laravel), Mobile Development (Dart, Flutter), Databases and Hosting (MySQL, Firebase, Supabase, Hostinger), and also experienced in productivity/creative tools like Microsoft Office, Adobe Suite, and OBS Studio.", "My tech stack revolves around modern web tech and mobile development (React, Flutter, Laravel, Python, MySQL, Firebase, Supabase, Hostinger), plus media tools like OBS Studio, Adobe Suite, and Microsoft Office."], chips: ["Projects", "About"] },
