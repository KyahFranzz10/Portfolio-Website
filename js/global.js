document.addEventListener('DOMContentLoaded', () => {
    ...
    const initChatbot = () => {
        const knowledgeBase = [
            ...
            { keywords: ['skill', 'tech', 'stack', 'language', 'know', 'html', 'css', 'javascript'], responses: ["I am highly skilled in Frontend (HTML, CSS, JS, React), Backend (Node.js, Python), and Databases (MySQL).", "My tech stack revolves around modern web tech: React ecosystem, Python backends, and responsive CSS."], chips: ["Projects", "About"] },
            ...
            { keywords: ['education', 'gpa', 'university', 'college', 'school'], responses: ["I hold a 3.8 GPA in Information Technology. Over the course of my degree, I've engaged in multiple hackathons and practical seminars."], chips: ["Gallery", "Contact"] },
